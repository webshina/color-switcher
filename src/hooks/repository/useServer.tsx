export const useServer = (props: { serverId: string }) => {
  const server = {
    id: 1,
      ...
      },
      {
        ...
        channels: [
          ...
          },
          {
            id: 2,
            name: '📘 チュートリアル',
            description: 'Web3.0の学習リソースやチュートリアルを共有しましょう',
            activityLevel: 3,
            inviteCode: 'hoge',
          },
          {
    ...
    members: [
      ...
      },
      {
        ...
        roles: ['crew'],
        description: '広島で働いているQAエンジニアです。よろしくお願いします。',
        isBot: false,
      },
      {
        id: 9,
      ...
      },
      {
        ...
        roles: ['admin', 'crew'],
        description: '仙台で働いているUXデザイナーです。よろしくお願いします。',
        isBot: false,
      },
    ],
  };
